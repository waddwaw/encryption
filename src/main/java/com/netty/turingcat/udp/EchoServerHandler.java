...
import static com.netty.turingcat.udp.EchoServer.addr1;
import static com.netty.turingcat.udp.EchoServer.addr2;
import static com.netty.turingcat.udp.EchoServer.channel;
...
public class EchoServerHandler extends SimpleChannelInboundHandler<DatagramPacket>{
    ...
    protected void channelRead0(ChannelHandlerContext ctx, DatagramPacket packet)
        ...
        if(str.equalsIgnoreCase("L")){
            //保存到addr1中 并发送addr2
            addr1 = packet.sender();
//            System.out.println("L 命令， 保存到addr1中 " + addr1.getHostName() + "--" + addr1.getPort());
        }else if(str.equalsIgnoreCase("R")){
            //保存到addr2中 并发送addr1
            addr2 = packet.sender();
//            System.out.println("R 命令， 保存到addr2中 " + addr2.getHostName() + "--" + addr2.getPort());
